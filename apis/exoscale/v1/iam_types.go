...
// SOS is the service type for Object Storage in exoscale
type SOS struct {
...
// Services are the accessible exoscale services of the IAMKey.
type Services struct {

	// +kubebuilder:validation:Required
	// SOS is the Object Storage Service in exoscale.
	// Only this service is supported
	SOS `json:"sos,omitempty"`
}
...
func (in *IAMKey) GetZone() string {
	return in.Spec.ForProvider.Zone
}
