...
func (fakeSettingsFetcher) GetDBAASSettingsMysql(ctx context.Context) (*exoscalesdk.GetDBAASSettingsMysqlResponse, error) {
	return &exoscalesdk.GetDBAASSettingsMysqlResponse{
...
var mysqlSettings = exoscalesdk.GetDBAASSettingsMysqlResponseSettings{
	Mysql: &exoscalesdk.GetDBAASSettingsMysqlResponseSettingsMysql{
		Properties: map[string]any{
			"net_write_timeout": map[string]any{
			...
			"internal_tmp_mem_storage_engine": map[string]any{
			...
			"information_schema_stats_expiry": map[string]any{
			...
			"sort_buffer_size": map[string]any{
			...
			"innodb_thread_concurrency": map[string]any{
			...
			"innodb_write_io_threads": map[string]any{
			...
			"innodb_ft_min_token_size": map[string]any{
			...
			"innodb_change_buffer_max_size": map[string]any{
			...
			"innodb_flush_neighbors": map[string]any{
			...
			"net_read_timeout": map[string]any{
			...
			"innodb_lock_wait_timeout": map[string]any{
			...
			"innodb_rollback_on_timeout": map[string]any{
			...
			"group_concat_max_len": map[string]any{
			...
			"net_buffer_length": map[string]any{
			...
			"innodb_print_all_deadlocks": map[string]any{
			...
			"innodb_online_alter_log_max_size": map[string]any{
			...
			"interactive_timeout": map[string]any{
			...
			"innodb_log_buffer_size": map[string]any{
			...
			"max_allowed_packet": map[string]any{
			...
			"max_heap_table_size": map[string]any{
			...
			"innodb_ft_server_stopword_table": map[string]any{
			...
			"innodb_read_io_threads": map[string]any{
			...
			"sql_require_primary_key": map[string]any{
			...
			"default_time_zone": map[string]any{
			...
			"long_query_time": map[string]any{
